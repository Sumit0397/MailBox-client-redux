...
const EmailComposer = () => {
  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      const response = await fetch(`https://mailbox-project-practice-default-rtdb.firebaseio.com/${senderEmail}/sendEmail.json`, {
        method: "POST",
        body: JSON.stringify({
          ...sentEmailObj
        }),
    ...
    try {
      ...
      const response = await fetch(`https://mailbox-project-practice-default-rtdb.firebaseio.com/${receiverEmail}/receiveEmail.json`, {
        method: "POST",
        body: JSON.stringify({
          ...receiveEmailObj
        }),
